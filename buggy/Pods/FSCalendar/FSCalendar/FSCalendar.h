...
@optional
//我的添加
- (void)calender:(FSCalendar *)calender setupCell:(FSCalendarCell *)cell date:(NSDate *)date;  //cellforrow
- (void)calender:(FSCalendar *)calender didselectedCell:(FSCalendarCell *)cell date:(NSDate *)date;  //didselected
/**
