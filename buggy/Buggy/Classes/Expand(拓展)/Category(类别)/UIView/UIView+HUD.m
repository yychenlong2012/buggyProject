...
{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self animated:YES];
    [hud setFrameWidth:[UIScreen mainScreen].bounds.size.width];
    [hud setFrameHeight:[UIScreen mainScreen].bounds.size.height];
    hud.backgroundColor=[Theme mineBgColor];
...
-(void)showLoadFinish{
    ...
    hud.yOffset=[UIScreen mainScreen].bounds.size.height/2.0-80;
    hud.removeFromSuperViewOnHide = YES;
    [hud hide:YES afterDelay:2.0f];
}
